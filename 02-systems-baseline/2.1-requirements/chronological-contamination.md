...
> Any inherited, introduced, altered, mixed, or mis-modelled state variable that causes a dating procedure to return a retrodictive age older than the actual elapsed duration of the object, event, or deposit being dated.

The term is broader than laboratory contamination. Candidate mechanisms may include:

- incorporation or reworking of older material;
- inherited isotopic or daughter-product inventories;
- uranium uptake, loss, or open-system behavior;
- reservoir effects;
- inherited or incompletely reset luminescence dose;
- thermal-history error;
- groundwater, mineral-binding, or hydrochemical alteration;
- catastrophic depositional or geochemical restructuring;
- stratigraphic mixing or correlation error;
- calibration error;
...
BWM shall keep the following categories distinct:

1. **Human existence chronology** — elapsed duration of human existence, including any biblically admissible pre-Fall interval.
2. **Human mortality chronology** — elapsed duration of human life under the post-Fall mortal order and the timing of human death/burial events.
3. **Observation** — the presently measurable state of a specimen or deposit.
4. **Operational measurement** — quantities obtained by an instrument or laboratory procedure.
5. **Retrodictive age** — elapsed time calculated by applying a historical model to present measurements.
6. **Actual elapsed age** — time since the historical event itself.
7. **Inherited/system-state age** — chronological information encoded in a system state that need not equal the elapsed duration of the specimen or event under examination.
...
- tools, structures, symbolic artifacts, settlement traces, and other evidence of human activity may be investigated as potentially pre-Fall without violating BWM-CHR-001;
- human skeletal remains produced by death and human burial contexts are post-Fall under BWM-CHR-001;
- the age of a human artifact does not automatically determine the age of an associated human death event;
...
3. What historical assumptions convert that measurement into elapsed time?
4. Which candidate chronological-contamination mechanisms could bias the result old?
5. Are the supposedly independent dating methods genuinely independent at the level of historical assumptions?
