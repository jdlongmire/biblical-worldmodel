# WP-BWM-0012 — Extended Pre-Fall Human Development Gap Model
...
Develop and pressure-test a Biblical WorldModel hypothesis that Genesis permits an extended, unmeasured interval between the creation of humanity and the Fall, during which human demographic, cultural, geographic, symbolic, and technological development may have occurred.

The model treats Scripture as primary epistemic authority and nature as secondary evidence. It does not assign an elapsed duration to the pre-Fall interval from scientific dating alone.
...
The investigation therefore tests the following candidate model:
...
A central sub-hypothesis is that numerical human age accounting is relevant to the post-Fall mortal order because human death enters through sin. On this reading, Adam's recorded 930 years may represent his mortal/post-Fall lifespan rather than requiring `T_preFall = 0`. This is an exegetical hypothesis to be tested, not a settled conclusion.

## Scriptural priority and method

The programme shall apply the following order:

1. establish explicit biblical constraints;
2. identify genuine textual underdeterminations;
3. distinguish necessary inference from model hypothesis;
4. use natural evidence to test or constrain hypotheses within the scriptural boundary;
5. preserve unresolved tensions rather than importing conventional chronology as an authority over the text.

Relevant primary biblical texts include Genesis 1:26–31; 2:7–25; 3:1–24; 4:1–26; 5:1–32; Romans 5:12–21; and 1 Corinthians 15:20–22, 45–49.
...
The work package shall investigate the approximately 50–60 ka limit of practical radiocarbon resolution as a secondary empirical datum.

The provisional distinction is:

`radiocarbon observability horizon != established elapsed-time boundary`

Finite radiocarbon determinations, lower limits such as `>50 ka`, laboratory background, contamination sensitivity, pretreatment quality, and calibration assumptions must remain distinct. The model shall not infer that humanity is 50–60 thousand elapsed years old merely because ordinary carbon dating loses resolving power in that range.
...
- exegesis of the creation-to-Fall chronological interval;
- the theological significance of human mortality for age accounting;
- Genesis 5 age formulas and their chronological zero-point;
- pre-Fall reproduction and population growth;
...
1. Perform a close textual and lexical study of Genesis 1–5 focused on temporal markers, reproduction, mortality, and genealogical age formulas.
